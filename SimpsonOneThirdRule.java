...
class SOTR{
    ...
    SOTR(double y0, double y_final,double y1, double y3,double y5,double y2,double y4,double lowerlim,double upperlim, double num_ofSteps){
        this.y5=y5;
        this.y3=y3;
        this.y1=y1;
    ...
    public double simpsonFormula(){
        return ((h()/3)*((y0+y_final)+4*(y1+y3+y5)+2*(y2+y4)));
    }
}
...
public class SimpsonOneThirdRule {
    public static void main(String[] args) {
        ...
        SOTR sotr = new SOTR(initValue,finValue,y1,y3,y5,y2,y4,lowlim,upperlim,steps);
        System.out.println(sotr.simpsonFormula());
    }
}
